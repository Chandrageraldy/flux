...
class FoodDetailsRoute extends PageRouteInfo<FoodDetailsRouteArgs> {
  FoodDetailsRoute({
    ...
    List<PageRouteInfo>? children,
          ...
          args: FoodDetailsRouteArgs(food: food, key: key),
  ...
  static PageInfo page = PageInfo(
    ...
    builder: (data) {
      ...
      return FoodDetailsPage(food: args.food, key: args.key);
    },
  );
}

class FoodDetailsRouteArgs {
  const FoodDetailsRouteArgs({required this.food, this.key});
...
class MoreRoute extends PageRouteInfo<void> {
  const MoreRoute({List<PageRouteInfo>? children}) : super(MoreRoute.name, initialChildren: children);
