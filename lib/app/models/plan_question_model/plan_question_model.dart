  ...
  PlanQuestion(
    ...
    pickers: [
      PlanPicker(
        ...
        icon: FaIcon(FontAwesomeIcons.venusMars, size: AppStyles.kIconSize20),
      ...
      PlanPicker(
        ...
        unit: Unit.cm.label,
        icon: FaIcon(FontAwesomeIcons.person, size: AppStyles.kIconSize20),
        // 100 to 250
      ...
      PlanPicker(
        ...
        unit: Unit.kg.label,
        icon: FaIcon(FontAwesomeIcons.weightScale, size: AppStyles.kIconSize20),
        // 20 to 150
      ...
      PlanPicker(
        ...
        icon: FaIcon(FontAwesomeIcons.calendar, size: AppStyles.kIconSize20),
        items: [],
      ),
    ],
  ),
  PlanQuestion(
    ...
    pickers: [
      PlanPicker(
        ...
        unit: Unit.kg.label,
        icon: FaIcon(FontAwesomeIcons.bullseye, size: AppStyles.kIconSize20),
        // 20 to 150
        items: List.generate(131, (index) => (index + 20).toString()),
      ),
    ],
