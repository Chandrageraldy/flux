  ...
  PlanQuestion(
    ...
    pickers: [
      PlanPicker(
        ...
        icon: FaIcon(FontAwesomeIcons.venusMars, size: AppStyles.kSize20),
      ...
      PlanPicker(
        ...
        unit: Unit.cm.label,
        icon: FaIcon(FontAwesomeIcons.person, size: AppStyles.kSize20),
        // 100 to 250
      ...
      PlanPicker(
        ...
        unit: Unit.kg.label,
        icon: FaIcon(FontAwesomeIcons.weightScale, size: AppStyles.kSize20),
        // 20 to 150
      ...
      PlanPicker(
        ...
        icon: FaIcon(FontAwesomeIcons.calendar, size: AppStyles.kSize20),
        items: [],
      ),
    ],
  ),
  PlanQuestion(
    ...
    pickers: [
      PlanPicker(
        ...
        unit: Unit.kg.label,
        icon: FaIcon(FontAwesomeIcons.bullseye, size: AppStyles.kSize20),
        // 20 to 150
        items: List.generate(131, (index) => (index + 20).toString()),
      ),
    ],
