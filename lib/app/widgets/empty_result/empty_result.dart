...
class EmptyResult extends StatelessWidget {
  const EmptyResult({required this.title, required this.message, required this.imagePath, super.key});
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(imagePath, width: AppStyles.kSize150, height: AppStyles.kSize150),
